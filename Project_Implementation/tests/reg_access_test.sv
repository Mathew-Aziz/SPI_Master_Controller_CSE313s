...
class reg_access_test;
  ...
  static task run(ref spi_ref_model ref_model, ref spi_coverage_col coverage);
    ...
    apb_wr(coverage, APB_CTRL, 32'h0000_0002);  // MSTR=1, EN=0
    apb_wr(coverage, APB_TX_DATA, 32'hAABB_CCDD);
